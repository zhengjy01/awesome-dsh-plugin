...
- [zhengjy01/dsh-flomo](https://github.com/zhengjy01/dsh-flomo) - flomo (浮墨笔记) integration: a web settings panel for the API URL / API Key plus flomo_send / flomo_config / flomo_status agent tools for writing notes, memos, and summaries.
